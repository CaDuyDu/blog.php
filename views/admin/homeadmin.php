<?php 
	...
	if(!isset($_SESSION['user'])){
		header("Location: http://duydu.zent:8080/unit08_MVC_Ajax/?mod=login&act=index");
	}
?>
<!doctype html>
<html lang="en">
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="homeadmin.php" class=""><i class="lnr lnr-home"></i> <span>Bảng Điều Khiển</span></a></li>
						<br>
						<li><a href="#"><span>QUẢN LÝ</span></a></li>
						<li><a href="../../index.php?mod=user" class=""><i class="fa fa-user" aria-hidden="true"></i><span>Quản Lý Người Dùng</span></a></li>
						<li><a href="../../index.php?mod=post" class=""><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span>Quản Lý Bài Viết</span></a></li>
						<li><a href="../../index.php?mod=tag" class=""><i class="fa fa-tags" aria-hidden="true"></i><span>Quản Lý Tags</span></a></li>
